    ...
    <footer className="relative bg-[#0A0A0A] text-white pt-10 pb-6 overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-8">
          ...
          <div>
            <h4
              className="font-bold text-white text-lg mb-8 uppercase tracking-widest"
              style={{ fontFamily: 'Space Grotesk, sans-serif' }}
            >
              Navigation
            </h4>
            <ul className="space-y-4">
              {["Dashboard", "Predictor", "Preferences", "Mentors"].map((item) => (
                <li key={item}>
                  <a
                    href="#"
          ...
          <div>
            ...
            <ul className="space-y-4">
              {["IIT Seat Matrix", "NIT/IIIT Comparison", "Fees Calculator", "Counseling Support"].map((item) => (
                <li key={item}>
                  <a
                    href="#"
                    className="text-white/60 hover:text-[#10B981] transition-colors text-sm font-medium flex items-center gap-2"
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-white/60">
                ...
                <a href="mailto:support@unipillar.com" className="text-sm font-medium hover:text-[#10B981] transition-colors">
        ...
        <div className="pt-4 border-t border-white/10 flex flex-col lg:flex-row justify-between items-center gap-3">
          <p className="text-white/40 text-xs font-medium">
            Copyright © 2024 Unipillar. Engineering Your Future with Precision.
          </p>
          <div className="flex gap-8">
            <a href="#" className="text-white/40 hover:text-[#10B981] text-xs font-medium underline underline-offset-4">
              Privacy Policy
            </a>
            <a href="#" className="text-white/40 hover:text-[#10B981] text-xs font-medium underline underline-offset-4">
              Terms of Service
